  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      ...
      setStats({
        ...
        streak: Math.floor(Math.random() * 30) + 1, // Will be calculated from activity_log later
      });

      setPieData([
        { name: "Completed", value: completed || 0, color: "hsl(160, 84%, 39%)" },
        { name: "Active", value: active || 0, color: "hsl(200, 70%, 50%)" },
      ]);
    };
    fetchStats();
  }, [user]);
  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatsCard icon={Flame} title="Day Streak" value={stats.streak} delay={0.2} />
